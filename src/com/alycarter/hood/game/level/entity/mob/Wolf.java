...
public class Wolf extends Mob{
	...
	public Wolf(Game game, Point2D.Double location) {
...
class EnemyAnimation extends AnimationLayer{
	private static TextureTileLoader sword1 = new TextureTileLoader("wolfWalk.png", 192);
	private static TextureTileLoader sword2 = new TextureTileLoader("wolfWalk.png", 192);
...
class EnemyDeathAnimation extends AnimationLayer{
	...
	private static TextureTileLoader sword= new TextureTileLoader("wolfWalk.png", 192/(int)Math.sqrt(chunks));
